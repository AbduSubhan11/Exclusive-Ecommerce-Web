...
function page() {
  return (
    <section className=" py-16 space-y-10">
      <Breadcrumb className="px-5 md:px-10 lg:px-16">
        <BreadcrumbList>
          <BreadcrumbItem>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href="/about" className="text-black">
              About
            </BreadcrumbLink>
          </BreadcrumbItem>
        </BreadcrumbList>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 ">
        {/* LEFT */}
        <div className="lg:w-[50%] space-y-5 px-5 md:px-10 lg:px-16">
          <h1 className="font-bold text-xl sm:text-[52px]">Our Story</h1>
